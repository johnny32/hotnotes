...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%  string lang = ViewBag.Lang;
        ...
        { %>
    <%: Lang.GetString(lang, ((TipusDocument)ViewBag.Tipus).ToString()) %>
    <%  }
        else
        { %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptsSection" runat="server">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#navFiltres a[href="<%: Url.Action("Filtrar", "Document", new { Tipus = (TipusDocument)ViewBag.Tipus }) %>"]').parent().addClass('active');
        });
    </script>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 <% if (ViewBag.Error == null)
       { %>
    <% string lang = ViewBag.Lang; %>
    <h2 style="margin-bottom: 2em;"><%: Lang.GetString(lang, ((TipusDocument)ViewBag.Tipus).ToString()) %></h2>
    ...
    <table id="tableDocuments" border="0" class="table table-striped table-bordered" style="width: 100%;">
        ...
        %>
            <tr>
                ...
                <th><a href="<%: Url.Action("Usuari", "Document", new { Id = d.IdUsuari }) %>"><%: d.Username %></a></th>
